...
Rails.application.config.middleware.use OmniAuth::Builder do
  provider :google_oauth2, '376282486981-rq8mp4h46j06t06ejd9hindfjt49flag.apps.googleusercontent.com', 'kMyKDUYEAbd9Ev-GAn3QMaV2', {scope: 'userinfo.email, userinfo.profile, https://www.googleapis.com/auth/calendar', client_options: {ssl: {ca_file: Rails.root.join('cacert.pem').to_s}}}
end
